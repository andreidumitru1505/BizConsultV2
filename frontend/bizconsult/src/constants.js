...
export const ideaGeneratorWelcomeMessage = 'We have taken into consideration your profile and found the perfect industry for your next project!'
export const ideaGeneratorProcessMessage = 'If you decide to pursue this opportunity, please make sure to click the Lock in button on the right and enlist your new company in the `My Companies` tab so we can help you find the most suitable business partners.'
export const ideaGeneratorMoreOptionsMessage = 'If this idea is not for you, we are very sorry to hear it, but do not worry! You can look into other fancy business fields by clicking the button below!'