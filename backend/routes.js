...
const { getSysAdminDashboardInfo, acceptExpert, declineExpert } = require('./controllers/systemAdminController')
...
router.post('/requestCollaboration',[
    body('requestCompanyId', "Please insert request company id").notEmpty(),
    body('offerCompanyId', "Please insert offer company id").notEmpty(),
    body('startDate', "Please insert start dates").notEmpty(),
    body('endDate', "Pleae insert end date").notEmpty(),
    body('hasDesiredProfit', "Please insert if collaboration has desired profit").notEmpty(),
    body('desiredProfitMetric')
...
router.post('/acceptCollaboration',[
    body('collaborationId', "Please insert collaborationId").notEmpty()
], acceptCollaboration)

router.post('/refuseCollaboration',[
    body('collaborationId', "Please insert collaborationId").notEmpty()
], refuseCollaboration)

router.post('/proposeFinishCollaboration',[
    body('collaborationId', "Please insert collaboration id").notEmpty(),
...
router.post('/acceptExpert',[
    body('expertId', "Please insert expert id").notEmpty()
], acceptExpert)

router.post('/declineExpert',[
    body('expertId', "Please insert expert id").notEmpty()
], declineExpert)
